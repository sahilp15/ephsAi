...
export default function AdminPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="flex items-center gap-2.5 text-2xl font-bold leading-none text-ep-charcoal sm:text-3xl">
          <Database aria-hidden className="h-7 w-7 text-ep-red" />
          Data Audit &amp; Guide Version
        </h2>
        <p className="mt-1 max-w-2xl text-sm text-ep-muted">
          Integrity report for the active course-guide dataset, including import
          provenance and version activation (see supabase/migrations).
        </p>
      </div>
