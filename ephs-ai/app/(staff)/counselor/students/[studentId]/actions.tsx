...
export function PrintButton() {
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-lg border border-ep-border bg-ep-card px-4 py-2 text-sm font-semibold text-ep-charcoal hover:bg-ep-bg"
    >
